...
summary: Crear una nueva aplicación para un clúster gestionado 
---
= Crear una nueva aplicación para un clúster gestionado
:allow-uri-read: 
...
Indica los valores deseados para el recurso App API que se va a crear.
...
| resourceSelectionCriteria | cadena | Verdadero  a| 
...
| GVKN | array[link:#GVKN["GVKN"]] | Verdadero  a| 
