...
summary: Enumera los activos de la aplicación para una copia de seguridad de la aplicación 
---
= Enumera los activos de la aplicación para una copia de seguridad de la aplicación
:allow-uri-read: 
