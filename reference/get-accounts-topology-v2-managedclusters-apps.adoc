...
summary: Lista las apps de un clúster gestionado 
---
= Lista las apps de un clúster gestionado
:allow-uri-read: 
...
| artículos | array[Cualquiera de: link:#app_2_2_get_response_body["app_2.2_get_response_body"], array[]] | Verdadero  a| 
