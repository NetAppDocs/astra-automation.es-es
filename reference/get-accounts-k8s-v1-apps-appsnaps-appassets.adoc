...
summary: Lista los activos de la aplicación para una instantánea de la aplicación 
---
= Lista los activos de la aplicación para una instantánea de la aplicación
:allow-uri-read: 
...
ID del recurso contenedor appSnap
