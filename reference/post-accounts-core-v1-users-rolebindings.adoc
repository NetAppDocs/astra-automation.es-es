...
api: true 
explorer: false 
permalink: reference/post-accounts-core-v1-users-rolebindings.html 
summary: Crear un nuevo vínculo de rol para un usuario 
---
= Crear un nuevo vínculo de rol para un usuario
:allow-uri-read: 


[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/accounts/{account_id}/core/v1/users/{user_id}/roleBindings`#
