...
summary: Enumera las vinculaciones de roles para un usuario en un grupo 
---
= Enumera las vinculaciones de roles para un usuario en un grupo
:allow-uri-read: 
...
| artículos | array[Cualquiera de: link:#roleBinding_1_1_get_response_body["roleBinding_1.1_get_response_body"], array[]] | Verdadero  a| 
