...
api: true 
explorer: true 
permalink: reference/post-accounts-core-v1-users-groups-rolebindings.html 
summary: Crear un nuevo enlace de rol para un grupo asociado a un usuario 
---
= Crear un nuevo enlace de rol para un grupo asociado a un usuario
:allow-uri-read: 


[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/accounts/{account_id}/core/v1/users/{user_id}/groups/{group_id}/roleBindings`#
