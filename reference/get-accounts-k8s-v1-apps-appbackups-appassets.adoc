...
summary: Enumera los activos de una aplicación a partir de una copia de seguridad de una app 
---
= Enumera los activos de una aplicación a partir de una copia de seguridad de una app
:allow-uri-read: 
