...
summary: Recuperar un activo de aplicación para una instantánea de aplicación y una app 
---
= Recuperar un activo de aplicación para una instantánea de aplicación y una app
:allow-uri-read: 
