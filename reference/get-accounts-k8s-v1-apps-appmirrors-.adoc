...
summary: Recuperar un recurso AppMirror para una app 
---
= Recuperar un recurso AppMirror para una app
:allow-uri-read: 
...
Devuelve el recurso de la API AppMirror almacenado en el cuerpo de respuesta JSON.
