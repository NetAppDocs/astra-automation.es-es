...
summary: Puede utilizar la siguiente secuencia de comandos para enumerar las aplicaciones de su cuenta Astra. 
---
...
[role="lead"]
Puede utilizar la siguiente secuencia de comandos para enumerar las aplicaciones de su cuenta Astra.


NOTE: Consulte link:../python/python_before.html["Antes de empezar"] Por ejemplo del archivo de entrada JSON requerido.
